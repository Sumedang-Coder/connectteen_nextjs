...
export function Admin(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10 1.25a4.75 4.75 0 100 9.5 4.75 4.75 0 000-9.5zM6.75 6a3.25 3.25 0 116.5 0 3.25 3.25 0 01-6.5 0zM10 12.25c-2.047 0-3.945.45-5.348 1.24C3.28 14.27 2.25 15.43 2.25 16.875v.087c-.001 1.03-.002 2.32 1.13 3.245.56.457 1.35.79 2.417 1.01 1.068.22 2.46.333 4.203.333.345 0 .68-.004 1.005-.013a.75.75 0 10-.042-1.499c-.316.008-.635.012-.963.012-1.687 0-2.996-.112-3.902-.299-.906-.186-1.383-.438-1.667-.67-.537-.44-.556-.97-.556-2.119 0-.81.6-1.627 1.78-2.29 1.16-.652 2.82-1.072 4.743-1.072.414 0 .75-.336.75-.75s-.336-.75-.75-.75z"
        fill="currentColor"
      />
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17.25 11.25c-.245 0-.49.06-.709.18l-2.5 1.36a1.5 1.5 0 00-.791 1.318v2.522c0 1.694 1.16 3.262 3.43 4.195a.75.75 0 00.57 0c2.27-.933 3.43-2.501 3.43-4.195v-2.522a1.5 1.5 0 00-.791-1.318l-2.5-1.36a1.5 1.5 0 00-.709-.18zm0 1.5 2.25 1.225v2.655c0 .96-.63 1.93-2.25 2.67-1.62-.74-2.25-1.71-2.25-2.67v-2.655l2.25-1.225z"
        fill="currentColor"
      />
    </svg>
  );
