          ...
          <>
            ...
            >
              <div className="bg-white rounded-3xl max-w-3xl w-full p-8 shadow-2xl overflow-y-auto max-h-[80vh] space-y-6">
                ...
                <button
                  onClick={() => setOpen(false)}
                  className="absolute top-4 right-4 bg-white/80 backdrop-blur border border-gray-200 hover:bg-gray-100 rounded-full w-10 h-10 flex items-center justify-center text-gray-600 shadow-md transition"
                >
                  ✕
                </button>
