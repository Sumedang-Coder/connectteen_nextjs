...
import { Search, MessageCircle, Music } from "lucide-react";
              ...
              {allMessages.map((msg: any) => (
                ...
                >
                  <CardContent className="bg-cyan-50 flex flex-col flex-1 min-h-[260px] rounded-2xl p-6 space-y-6">
                    ...
                    {/* Song */}
                    {msg.song_id ? (
                      <div className="mt-auto bg-linear-to-r from-cyan-500 to-blue-500 rounded-2xl p-4 flex items-center gap-4 shadow-md group-hover:shadow-lg transition-shadow">
                        {msg.song_image ? (
                          <img
                            src={msg.song_image}
                            alt={msg.song_name || "Song Image"}
