...
export default function HistoryPage() {
  ...
  // Menggunakan selector untuk performa (seperti versi Dev 1) namun tetap lengkap (versi Anda)
  ...
  // Prevent scroll saat modal buka (Fitur Anda)
  useEffect(() => {
  ...
  // Filter pencarian (Gunakan useMemo untuk efisiensi)
  const filteredMessages = useMemo(() => {
    if (!searchQuery) return myMessages;

    return myMessages.filter((msg) =>
      [msg.message, msg.recipient_name, msg.song_name, msg.song_artist].some(
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-linear-to-br from-cyan-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-6 py-14 grid lg:grid-cols-2 gap-12 items-center animate-fade-in">
          <div>
            ...
            <div className="relative max-w-xl">
              ...
              <Input
                className="h-14 pl-12 text-gray-900 bg-white"
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-6 animate-fade-in">
          ...
          <p className="text-gray-600">Total {myMessages.length} pesan</p>
        </div>
              ...
              >
                <CardContent className="bg-cyan-50 flex flex-col flex-1 min-h-[260px] rounded-2xl p-6 space-y-6">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 p-2 rounded-full bg-white shadow-md hover:bg-red-50 transition z-10"
                  >
      ...
      {/* DELETE MODAL (UI Anda lebih informatif) */}
      {showDeleteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="w-full max-w-[380px] bg-white rounded-2xl shadow-2xl p-8 animate-fade-in">
            <h2 className="text-xl font-semibold mb-2">Hapus Pesan?</h2>
