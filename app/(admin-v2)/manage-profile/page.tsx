                        ...
                        <div className="lg:col-span-1 flex flex-col items-center">
                            <div className="relative group">
                                ...
                                <button
                                    ...
                                    className="absolute -bottom-4 -right-4 p-4 bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-500/40 hover:bg-blue-700 hover:scale-110 active:scale-95 transition-all z-10"
                                >
                                    <Camera size={20} />
                                </button>
                                <input
                            ...
                            <p className="mt-4 text-[11px] text-slate-400 text-center font-medium leading-relaxed max-w-[150px]">
                                Disarankan gambar 1:1, maksimal 5MB (JPG/PNG).
                            </p>
                        </div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all font-bold text-slate-700 placeholder:text-slate-400"
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-200 space-y-6">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-black text-slate-900 tracking-tight">Kredensial Login</h3>
                                    <span className="text-[10px] font-black text-blue-600 bg-blue-50 px-2 py-1 rounded-md uppercase tracking-widest">Opsional</span>
                                </div>
